...
export default function SlotSearch({ loading, onSearch }: SlotSearchProps) {
  ...
  const inputClass = 'w-full px-3 py-2.5 border border-slate-200 rounded-lg text-base min-h-12 sm:text-sm sm:min-h-0 bg-white focus:outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 dark:bg-slate-700 dark:border-slate-600 dark:text-slate-100'

  return (
    <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-sm sm:p-5">
